            ...
            <div class="col-md-6 d-flex flex-column justify-content-center align-items-center tw-bg-white">
                <div class="tw-w-3/5 tw-p-6 tw-shadow-lg tw-rounded-lg">
                    ...
                    <form method="POST" action="{{ route('login.submit') }}" class="tw-space-y-4">
                        ...
                        <button type="submit" class="tw-bg-gray-400 tw-text-white tw-font-bold tw-py-3 tw-px-8 tw-text-sm tw-rounded-full tw-transition-all tw-duration-300 tw-ease-in-out hover:tw-bg-[#24CFF4] focus:tw-bg-[#24CFF4] tw-block tw-mx-auto">
                            Sign in
                        </button>
                    </form>

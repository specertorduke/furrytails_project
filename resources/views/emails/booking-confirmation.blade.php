...
<head>
    ...
    <title>Booking Confirmed – FurryTails</title>
    <style>
        ...
        .header { background: #24CFF4; padding: 30px 40px; text-align: center; }
        ...
        .badge { display: inline-block; background: #d1fae5; color: #065f46; padding: 3px 10px; border-radius: 12px; font-size: 13px; font-weight: 600; }
        .amount { font-size: 22px; color: #24CFF4; font-weight: 700; }
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p style="color:#374151;font-size:15px;">
            Your {{ $bookingType }} has been successfully booked. Here's a summary:
        </p>
        ...
        <div class="card">
            ...
            <div class="row"><span class="label">Status</span><span class="value"><span class="badge">{{ $booking->status }}</span></span></div>
        </div>
        @else
        <div class="card">
        ...
        <div class="card">
            ...
            <div class="row"><span class="label">Amount</span><span class="value"><span class="amount">₱{{ number_format($payment->amount, 2) }}</span></span></div>
            ...
            <div class="row"><span class="label">Reference #</span><span class="value">{{ $payment->reference_number }}</span></div>
            @endif
        </div>
        @endif

        <p class="note">
            If you need to cancel or reschedule, please log in to your account or contact us at least 24 hours in advance.<br>
            Thank you for trusting FurryTails with your pet's care! 🐶🐱
        </p>
    </div>
    <div class="footer">

        ...
        <div class="tw-relative tw-bg-gray-800 tw-rounded-lg tw-shadow-sm tw-transform tw-transition-all">
            ...
            <form id="adminAppointmentForm" class="tw-p-4 md:tw-p-5">
                ...
                <div class="tw-mb-4">
                    ...
                    <select id="selected-user" name="selected-user" class="tw-bg-gray-700 tw-border tw-border-gray-600 tw-text-white tw-text-sm tw-rounded-lg tw-focus:tw-ring-[#24CFF4] tw-focus:tw-border-[#24CFF4] tw-block tw-w-full tw-p-2.5 placeholder:tw-opacity-50 placeholder:tw-text-gray-400" required>
                ...
                <div class="tw-mb-4">
                    ...
                    <select id="selected-pet" name="selected-pet" class="tw-bg-gray-700 tw-border tw-border-gray-600 tw-text-white tw-text-sm tw-rounded-lg tw-focus:tw-ring-[#24CFF4] tw-focus:tw-border-[#24CFF4] tw-block tw-w-full tw-p-2.5 placeholder:tw-opacity-50 placeholder:tw-text-gray-400" required disabled>
                ...
                <div class="tw-grid tw-grid-cols-2 tw-gap-4 tw-mb-4">
                    ...
                    <div>
                        ...
                        <select id="appointment-time" name="appointment-time" class="tw-bg-gray-700 tw-border tw-border-gray-600 tw-text-white tw-text-sm tw-rounded-lg tw-focus:tw-ring-[#24CFF4] tw-focus:tw-border-[#24CFF4] tw-block tw-w-full tw-p-2.5 placeholder:tw-opacity-50 placeholder:tw-text-gray-400" required disabled>
                ...
                <div class="tw-mb-4">
                    ...
                    <select id="service" name="service" class="tw-bg-gray-700 tw-border tw-border-gray-600 tw-text-white tw-text-sm tw-rounded-lg tw-focus:tw-ring-[#24CFF4] tw-focus:tw-border-[#24CFF4] tw-block tw-w-full tw-p-2.5 placeholder:tw-opacity-50 placeholder:tw-text-gray-400" required>
                ...
                <div id="admin-service-details-card" class="tw-mb-4 tw-hidden tw-rounded-lg tw-border tw-border-gray-700 tw-bg-gray-900/50 tw-p-4">
                    <div class="tw-flex tw-items-start tw-gap-3">
                        <div id="admin-service-details-image-wrap" class="tw-h-16 tw-w-16 tw-shrink-0 tw-overflow-hidden tw-rounded-lg tw-bg-gray-700 tw-flex tw-items-center tw-justify-center">
                            <i class="fas fa-concierge-bell tw-text-xl tw-text-gray-400"></i>
                        </div>
                        <div class="tw-flex-1">
                            <div class="tw-flex tw-items-start tw-justify-between tw-gap-3">
                                <div>
                                    <p class="tw-text-xs tw-uppercase tw-tracking-wide tw-text-gray-400">Selected Service</p>
                                    <h4 id="admin-service-details-name" class="tw-mt-1 tw-text-base tw-font-semibold tw-text-white">-</h4>
                                </div>
                                <span id="admin-service-details-category" class="tw-rounded-full tw-bg-[#24CFF4]/15 tw-px-3 tw-py-1 tw-text-xs tw-font-medium tw-text-[#8deeff]">-</span>
                            </div>
                        </div>
                    </div>
                    <p id="admin-service-details-description" class="tw-mt-3 tw-text-sm tw-leading-6 tw-text-gray-300">Choose a service to see the details here.</p>
                    <div class="tw-mt-4 tw-flex tw-items-center tw-justify-between tw-border-t tw-border-gray-700 tw-pt-3">
                        <span class="tw-text-sm tw-text-gray-400">Price</span>
                        <span id="admin-service-details-price" class="tw-text-base tw-font-semibold tw-text-white">-</span>
                    </div>
                </div>
...
const AdminAppointmentModal = {
    ...
    init: function() {
        ...
        this.elements.serviceDetailsCard = document.getElementById('admin-service-details-card');
        this.elements.serviceDetailsImageWrap = document.getElementById('admin-service-details-image-wrap');
        this.elements.serviceDetailsName = document.getElementById('admin-service-details-name');
        this.elements.serviceDetailsCategory = document.getElementById('admin-service-details-category');
        this.elements.serviceDetailsDescription = document.getElementById('admin-service-details-description');
        this.elements.serviceDetailsPrice = document.getElementById('admin-service-details-price');
    ...
    renderServiceImage: function(service) {
        ...
        this.elements.serviceDetailsImageWrap.innerHTML = '<i class="fas fa-concierge-bell tw-text-xl tw-text-gray-400"></i>';
    },
